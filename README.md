...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const filenameToTitle = n => n.replace(/\.html$/i, '');
    ...
    function createWindow(pageNameRaw){
        const pageName = ensureHTML(pageNameRaw);

        if(windowsState[pageName]){
            const msg = document.createElement("div");
            msg.textContent = "ERROR: This Page Is Already Open";
        ...
        const fullBtn = document.createElement("span"); fullBtn.innerText="🗖";
        const closeBtn = document.createElement("span"); closeBtn.innerText="❌";
        ...
        const url = "https://cdn.jsdelivr.net/gh/Flamed-Games/Flamed-Lite@master/src/" + pageName;
    ...
    form.addEventListener("submit", function(e){
        ...
        if(val === "list"){
            ...
            const page = pages.find(p =>
                val === p.name.toLowerCase() ||
                val === p.name.replace(".html","").toLowerCase()
            );
...
<div class="terminal">
    <div id="terminal-output">
        ...
        <div><a href="https://discord.gg/8Xx6KptcQS">Join The Discord!</a></div>
